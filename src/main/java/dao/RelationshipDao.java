...
public class RelationshipDao {
    ...
    @Transactional
    public List<UserTable> getRelationList(UserTable user, RelationType relType) {
        List<UserTable> result = new ArrayList<UserTable>();
    ...
    public List<UserTable> getFOFlist(List<UserTable> users, RelationType relType) {
        ...
        for(UserTable user: users) {
            List<UserTable> friends = getRelationList(user, relType);
    ...
    @Transactional
    public List<Relationship> getFriendRequests(UserTable user) {
    ...
    @Transactional
    public Relationship getRelationByUsername(UserTable user, UserTable target) {
        EntityManager em = EntityManagerProvider.get();
        Query q;
